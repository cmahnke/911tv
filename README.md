...
And both the monster and the theme are of course a reference to [Godzilla](https://en.wikipedia.org/wiki/Godzilla) (although not necessarily in the [variant](https://de.wikipedia.org/wiki/Godzilla_(1998)) by [Roland Emmerich](https://de.wikipedia.org/wiki/Roland_Emmerich)), who is an embodiment of the [atomic bombs dropped on Japan in 1945](https://en.wikipedia.org/wiki/Atomic_bombings_of_Hiroshima_and_Nagasaki).
